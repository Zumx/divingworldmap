    ...
    <div style={{ minHeight: '100vh' }}>
      ...
      >
        <div className="wm-fade-up" style={{ maxWidth: 1100, margin: '0 auto' }}>
          ...
          <div style={{ marginTop: '2rem', display: 'flex', gap: '0.9rem', flexWrap: 'wrap' }}>
            <Link href="/map" style={{ background: 'var(--c-primary)', color: 'var(--c-accent)', padding: '0.9rem 1.6rem', borderRadius: 6, textDecoration: 'none', fontFamily: 'var(--font-sans)', fontWeight: 500, fontSize: '0.95rem', boxShadow: '0 4px 14px -4px rgba(11,61,98,0.4)' }}>
              Open the map →
            </Link>
          </div>
      ...
      <footer style={{ background: 'var(--c-primary)', borderTop: '2px solid var(--c-accent)', padding: '2.5rem 2rem' }}>
        <div style={{ maxWidth: 1100, margin: '0 auto', display: 'flex', justifyContent: 'space-between', flexWrap: 'wrap', gap: '1rem', alignItems: 'baseline' }} className="wm-stack-mobile">
          ...
          <div style={{ fontFamily: 'var(--font-sans)', color: 'rgba(255,255,255,0.62)', fontSize: '0.82rem' }}>
            Data: <a href={site.dataCreditUrl} target="_blank" rel="noopener noreferrer" style={{ color: 'rgba(255,255,255,0.8)' }}>{site.dataCredit}</a> · {countryCount} countries · {total} {site.itemPlural}
          </div>
          <Link href="/map" style={{ color: 'rgba(255,255,255,0.82)', textDecoration: 'none', fontFamily: 'var(--font-sans)', fontSize: '0.85rem' }}>Open map →</Link>
        </div>
      </footer>
    </div>
  )
