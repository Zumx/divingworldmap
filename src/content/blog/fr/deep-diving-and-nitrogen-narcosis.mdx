...
Pour les épaves profondes comme le Thistlegorm en mer Rouge (dont le pont supérieur est à 18 mètres mais les cales les plus profondes descendent à 32 mètres), ou le Zenobia au large de Chypre (fond à 42 mètres), la gestion du temps fond est la compétence centrale. [Consultez la carte des épaves et sites profonds](/map) pour planifier vos explorations.
